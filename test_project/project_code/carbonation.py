...
def Carb_depth(t, pars):
    """Carb_depth, Master model function, calculate carbonation depth and the k constant of sqrt of time from all the
    ...
    t : float
        time [year]
    pars : object/instance of wrapper
    ...
    Note
    ----
        Notes ----- intermediate parameters calculated and attached to 
...
# weather function
def W_t(t, pars):
    """W_t "Calcuate weather function W_t, a parameter considering the meso-climatic conditions due to wetting events of concrete surface
    ...
    pars.b_w : exponent of regression [-] ND(0.446, 0.163) built-in

    param t_0 : time of reference [years]
